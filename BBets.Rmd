...
On average profit is about equal to 280$
...
```{r}
bank =vector('numeric')
for (i in 1:100) { bank[i] = BrLw(35, 4.4, 637)
}
print(mean(bank))
hist(bank)
varbank=var(bank)
...
The amount of money to make the bet even would be 4 dollars and 40 cents.
...
The size of class to make the bet most fair would be 28.
